...
void Student_of_mipt::setInfo(const std::string& name, int course, double done_zadavalnik, double time_until_deadline)
{
    this->name = name;
    this->course = course;
...
void Student_of_mipt::printInfo()
{
...
std::string Student_of_mipt::getCategory()
{
    if (course < 2)
    {
        return "Pekus_baby";
...
std::string Student_of_mipt::getState()
{
